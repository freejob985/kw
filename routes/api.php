...
Route::get('abbreviation/get','userControllerApi@abbreviation_get');//done
...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::post('hide_chat/{chat}','userControllerApi@hideChat')->name($prefix.'.'.'hideChat');
    Route::post('hide_all_chat','userControllerApi@hideAllChat')->name($prefix.'.'.'hideAllChat');
    ...
    */
    ...
    Route::post('story_seen/{story}','userControllerApi@storySeen');
    Route::get('get_story_views/{story}','userControllerApi@getStoryViews');

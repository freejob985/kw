					...
					<div class="m-content">
						...
						<div class="m-portlet m-portlet--mobile">
							<div class="m-portlet__body">
								<form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('monitors.insert')}}">
										<div class="m-portlet__body">
		                                   {{csrf_field()}}
		                                                                                                                          @if($errors->any())
    ...
    @endif
											...
											<div class="form-group m-form__group">
												<label for="birth">
                                                  ...
                                                  <select class="form-control m-input" id="monitor_type" name="monitor_type" >
											...
											<div class="m-form__group form-group">
																...
																<div class="m-radio-list" style="width: 100px;">
																	<label class="m-radio m-radio--bold">
																		<input type="radio" name="visibility" value="visible" checked>
																		{{__('admin.visible')}}
																		<span></span>
																	</label>
																	<label class="m-radio m-radio--bold">
